  ...
  return (
    <div
      style={{
        ...
        background: "linear-gradient(135deg, #2D2A26 30%, #817144 70%)",
        position: "relative",
        overflow: "hidden",
        padding: "16px",
      ...
      <style>{`
        ...
        .soccer-ball-bg {
            ...
            background: radial-gradient(
                circle at center,
                rgba(255, 255, 255, 0.5) 0%,   /* Brighter center */
                rgba(255, 255, 255, 0.3) 50%,  /* Mid-tone */
    ...
    return (
      ...
      >
        {!video ? (
          ...
          >
            <UploadCloud style={{ width: "50px", height: "50px", color: "#F7D82F" }} />
            <span
              style={{
                color: "#F7D82F",
                marginTop: "12px",
